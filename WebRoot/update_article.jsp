				...
				<div class="col-md-8" id="mainstay">
			       ...
			       <!--  <div class="breadcrumb" id="zan-breadcrumb"></div> -->
					...
					<!-- 标题栏开始 -->
						...
						<input class="form-control" type="text" name="article_title" value="${article.article_title }" placeholder="文章标题..."> 
						<br>
					<!-- 标题栏结束 -->
				    ...
				    <input name="article_context" id="article_context" type="text" hidden="true" value="" hidden="true">
				    <br>
				    
				    <div class="row">
				    	<div class="col-md-8">
							<input class="form-control" type="text" name="article_tag" value="${article.article_tag }" placeholder="文章标签..."> 
						</div>
						<div class="col-md-4">
				   	...
				   	<br>
				    <input id="release_bt" class="btn btn-primary btn-lg btn-block" type="submit" value="更 新">
				    </form>
				</div>
				<!-- 文本编辑模块结束 -->
