...
public class UploadArticleHeadServlet extends HttpServlet {

	public UploadArticleHeadServlet() {
		super();
	}
...
System.out.println("url="+url);
			...
			request.getSession().setAttribute("article_head_url", url);
			request.getRequestDispatcher("t_editor.jsp").forward(request, response);
