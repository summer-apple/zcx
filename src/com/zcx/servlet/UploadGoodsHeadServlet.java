...
public class UploadGoodsHeadServlet extends HttpServlet {

	public UploadGoodsHeadServlet() {
		super();
	}
...
System.out.println(extendboo);				
					...
					if (extendboo) {
						...
						adjunctname = store_id+sdf.format(date)+"."+extend;//rename
						
						
						//adjunctname = new Date().toString()+"."+extend;//rename
						
						
System.out.println("adjunctname="+adjunctname);
						address = fileDir + "/" + adjunctname;
System.out.println("address="+address);
						url = "img/goods/"+adjunctname;
System.out.println("url="+url);
			...
			request.getSession().setAttribute("goods_head_url", url);
