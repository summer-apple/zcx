...
public class GetOrderByStoreServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetOrderByStoreServlet() {
		super();
	}
...
System.out.println("GetOrderByStore start********");		
		...
		List<Order> order_list = os.getOrderByStore(user.getUser_store());
		request.getSession().setAttribute("order_list", order_list);
System.out.println("GetOrderByStore end********");		
